...
- Listing all persons in the directory.
- Retrieving detailed information about a person, including their contact information.
- Generating a report of directory statistics based on the location of the persons.
...
- Required report content:
    - Location
    - Number of persons registered in the directory at that location
...
## Notes
- You can experiment the application via information in appsettings.
